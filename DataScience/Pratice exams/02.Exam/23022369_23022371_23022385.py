...
# dataframe_penguins = dataframe_penguins.dropna(
#     subset='sex')  # Remove todos os NaN da coluna sex
...
# Remover linhas com NaN na coluna 'sex'
...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, test_size=0.2)  # alocando 20% dos dados pra teste
